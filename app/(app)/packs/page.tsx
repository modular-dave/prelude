  ...
  return (
    <div className="relative h-full overflow-y-auto p-6 pt-16 font-mono" style={{ background: "var(--bg)" }}>
      <div className="animate-fade-slide-up max-w-2xl mx-auto">
        <span className="t-title" style={{ color: "var(--text)" }}>memory packs</span>
        <p className="mt-1 t-tiny" style={{ color: "var(--text-faint)" }}>
          export, import, and manage memory packs
        </p>

        {/* ── Export ── */}
        <div className="mt-6" style={{ borderTop: "1px solid var(--border)", paddingTop: 12 }}>
        ...
        {packHistory.length > 0 && (
          <div className="mt-6" style={{ borderTop: "1px solid var(--border)", paddingTop: 12 }}>
            ...
            <div className="mt-2 space-y-1.5">
              {packHistory.map((h, i) => (
                <div key={i} className="flex items-center gap-2 rounded-[4px] px-2.5 py-1.5"
                ...
                >
                  ...
                  <span className="t-micro" style={{ color: "var(--text-faint)" }}>
                    {new Date(h.exportedAt).toLocaleDateString()}
                  </span>
                  <button
                    onClick={() => {
